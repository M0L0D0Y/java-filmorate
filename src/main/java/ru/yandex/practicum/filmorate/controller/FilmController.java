...
public class FilmController {
    ...
    public void deleteFilm(@RequestParam long id) throws NotFoundException, ValidationException {
    ...
    public void addLike(@PathVariable long id,
                        @PathVariable long userId) throws NotFoundException, ValidationException {
